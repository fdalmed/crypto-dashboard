...
export const metadata: Metadata = {
  title: "About",
  description: "Learn about the cryptocurrency market data, comparison tools, and educational calculators available on AssetZeno.",
  alternates: { canonical: "/about" },
};

export default function AboutPage() {
  return <PublicPage eyebrow="About" title="About AssetZeno" introduction="AssetZeno is an informational website for exploring cryptocurrency market data and practical research tools." sections={[
