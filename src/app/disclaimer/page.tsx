...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Important informational and financial disclaimer for AssetZeno market data and tools.",
  alternates: { canonical: "/disclaimer" },
};

export default function DisclaimerPage() {
  return <PublicPage eyebrow="Disclaimer" title="Important disclaimer" introduction="AssetZeno provides general information and educational utilities only." sections={[
